...
| FIGMA-004 | Clients (Shops) | 8-col table, ClientAvatar (initials), StatusBadge, 3 modals (add/edit/delete), search/status filter | `[x]` |
...
**Docs:** `docs/features/admin-layout-shell.md` ✅  `docs/features/dashboard.md` ✅  `docs/features/products.md` ✅  `docs/features/clients.md` ✅ — one doc per page as it completes.
