    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      >
        ...
        <div className="px-6 pt-6 pb-5 flex gap-3.5">
          ...
          <div>
            <p className="text-sm font-semibold text-ink-900">{c.delete.title}</p>
            <p className="text-sm text-ink-600 mt-1">{category.name}</p>
            <p className="text-[13px] text-ink-500 mt-2">{c.delete.warning}</p>
          </div>
        </div>
